...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            OutputStream outputStream = new FileOutputStream("D:\\test.txt"); //your_file_name);
            InputStream inputStream = new FileInputStream("D:\\test.txt"); //your_file_name);

            User user1 = new User();
            user1.setFirstName("Serj");
            user1.setLastName("Nimble");
            user1.setBirthDate(new Date(16, 12, 13));
            user1.setMale(true);
            user1.setCountry(User.Country.OTHER);

            User user2 = new User();
            user2.setFirstName("Serj2");
//            user2.setLastName("Nimble2");
//            user2.setBirthDate(new Date(16, 02, 01));
//            user2.setMale(true);
