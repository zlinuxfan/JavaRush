...
//        System.out.println(modifiersOfThisClass + " " + Modifier.PUBLIC + " " + Modifier.STATIC);
...
//        System.out.println(modifiersOfMethod + " " + Modifier.STATIC);
    }

    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        int answer = allModifiers & specificModifier;
